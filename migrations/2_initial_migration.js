...
module.exports = function(deployer) {
  deployer.deploy(CrowdsaleController,config.startBlock,config.endBlock,config.initialExchangeRate,config.presaleAmount,config.name,config.symbol,config.decimals);
